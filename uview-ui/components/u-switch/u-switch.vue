<template>
	<view class="u-switch" :class="[value == true ? 'u-switch--on select-border' : '', disabled ? 'u-switch--disabled' : '']" @tap="onClick"
	 :style="[switchStyle]">
		<view class="u-switch__node node-class" :class="[value == true ? 'select-circle' : 'circle']" :style="{
